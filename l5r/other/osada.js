const townName1 = ['']
const townName2 = ['Skała', 'Woda', 'Zatruta', 'Sczęśliwa', 'Fortuna', 'Herbata', ]
...
if (coWyrozniaTaOsadeRoll === 'Festiwal lub święto') {
    ...
    return wiocha = coWyrozniaTaOsadeRoll + ': ' + festiwalRoll;
} else {
    return wiocha = coWyrozniaTaOsadeRoll
}
}

const osadaPrinter = ``

console.log(osada() + ' ; ' + osada() + ' ; ' + osada() + ' ; ' + osada() + ' ; ' + osada() + ' ; ' + osada() + ' ; ' + osada() )