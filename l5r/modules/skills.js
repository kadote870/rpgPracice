...
const skillsIntuicja = ['Aktorstwo', 'Dyplomacja', 'Etykieta', 'Gawędziarstwo', 'Handel', 'Hazard', 'Iaijutsu – pojedynek',
    'Jeździectwo', 'Muzyka', 'Poezja', 'Szczerość', 'Torturowanie', 'Uwodzenie'];

const skillsPustka = ['Ceremonia parzenia herbaty', 'Medytacja']

const skillsRefleks = ['Kyujutsu - Łuk']

const skillsRrozne = ['Rzemiosło', 'Śledztwo', 'Wysportowanie']

const skillsSila = ['Zapasy']

const skillsSpostrzegawczosc = ['Heraldyka', 'Kaligrafia', 'Polowanie', 'Taktyka']

const skillsZiemia = ['Miecznik', 'Płatnerz']

const skillsZrecznosc = ['Muzyka', 'Fałszerstwo', 'Jeździectwo', 'Miecz', 'Obrona', 'Skradanie się', 'Ślusarstwo', 'Taniec',
    'Wachlarz bojowy', 'Walka wręcz']